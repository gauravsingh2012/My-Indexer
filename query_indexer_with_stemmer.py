...
def queryElasticSearch(queryTermsWithoutStopWords, queryTFDict):
    ...
    docIdMap = readDocIdToMemory(docIdMap, "docIdMapStemmer.txt")
    ...
    return dict
    #writeQueryModelsToFile(dict, queryNo,"okapiBm25MyIndexerStemmer.txt",100)
...
def queryElasticSearchForSmoothing(queryTermsWithoutStopWords, queryTFDict):
    ...
    writeQueryModelsToFile(smoothingDict, queryNo, "laplaceSmoothingMyIndexerStemmer.txt",100)
    print queryNo + " Finished"        
...
def queryElasticSearchForJelinek(queryTermsWithoutStopWords, queryTFDict):
    ...
    writeQueryModelsToFile(smoothingDict, queryNo, "jelinekMercerSmoothingStemmer.txt",100)
    print queryNo + " Finished"
...
def storeLengthOfDocumentsInDictionary():
    file = open("lengthOfDocumentsStemmer.txt", "r")
    dict = {}
    for line in file:
...
def proximitySearchModel(queryTermsWithoutStopWords, queryTFDict, combinedDict):
    ...
    writeQueryModelsToFile(combinedDict, queryNo,"proximityStemmer.txt",100)
    print queryNo + " Finished"
